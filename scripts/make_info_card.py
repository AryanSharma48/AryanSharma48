...
# ===========================================================================
HOST = "Aryan"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Product Engineer @ Sparklyt"),
    ("kv", "Prev", "Backend and Distributed Systems Intern @ TechX"),
    ("kv", "Also", "Open Source Founder and Maintainer"),
    ("kv", "Edu", "Btech. CSE, Manipal University Jaipur '29"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "JavaScript, TypeScript, Python, C++"),
    ("kv", "Frontend", "React, Next.js, Astro"),
    ("kv", "Backend", "Node, Express, FastAPI, Nginx"),
    ("kv", "Database", "Postgres, Redis, MongoDB"),
    ("kv", "AI / ML", "Pytorch, Transformers, RAG, RLFR, Agents"),
    ("kv", "Cloud", "AWS, Docker, CI/CD, Vercel"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Technical Head @ACM, MUJ"),
    ("bul", "2X Hackathon Winner"),
    ("gap",),
    ("sec", "GitHub"),
    ("kv", "Contribs", "972 (Last Year)"),
    ("kv", "Stars", "11"),
]
